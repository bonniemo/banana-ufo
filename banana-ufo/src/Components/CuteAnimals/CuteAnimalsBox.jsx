    ...
    return (
        <>
            <section className="CuteAnimalsBox">
                ...
                {data.map((animal) => (
                     <CuteAnimals key={animal.name} name = {animal.name} species = {animal.species} favFood = {animal.favourite_food} bestie={animal.best_friend} favSpot={animal.favourite_spot} image_url={animal.image_url}/>
                ))}
                </section>
            </section>
        </>
